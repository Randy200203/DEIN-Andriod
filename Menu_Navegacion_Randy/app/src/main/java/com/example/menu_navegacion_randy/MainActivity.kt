package com.example.menu_navegacion_randy
...
//        bottomNavigationView .setSelectedItemId(R.id. page_home)
    ...
    private fun onItemSelectedListener (item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id. page_home -> {
                showPageFragment(R.drawable. baseline_home_24, R.string. bottom_nav_home)
                return true
            }
            R.id. page_fav -> {
                showPageFragment(R.drawable. baseline_favorite_24, R.string. bottom_nav_fav)
                return true
            }
            R.id. page_search -> {
                showPageFragment(R.drawable. baseline_search_24, R.string. bottom_nav_search)
                return true
            }
            R.id. page_settings -> {
                showPageFragment(R.drawable. baseline_settings_24, R.string. bottom_nav_settings)
                return true
            }
